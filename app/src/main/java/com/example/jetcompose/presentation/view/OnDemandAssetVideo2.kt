...
class OnDemandAssetVideo2 : Activity() {
    ...
    private fun initInstallTime() {
        try {
            ...
            getInputStreamFromAssetManager("ElephantsDream.mp4");
    ...
    private fun initOnDemand() {
        ...
        file.list()?.forEachIndexed { index, it ->
            ...
            if (file.exists() && it.equals("ElephantsDream.mp4")) {
                val video: Uri = Uri.parse(videoFile.absolutePath)
                Thread.sleep(500)
